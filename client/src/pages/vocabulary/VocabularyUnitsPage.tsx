...
export const VocabularyUnitsPage: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-white mb-2">Chọn Bài Học ({levelKey})</h1>
        <p className="text-gray-400">Danh sách các Unit thuộc trình độ {levelKey}.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {units.length === 0 ? (
          <div className="col-span-full p-8 text-center text-gray-400 bg-gray-900 border border-gray-800 rounded-2xl">
          ...
          units.map(unit => (
            <div 
              ...
              className="bg-gray-900 border border-gray-800 rounded-2xl p-5 cursor-pointer hover:border-indigo-500/50 hover:bg-gray-800 transition-all flex justify-between items-center group"
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">{unit.totalWords} từ vựng</p>
                </div>
              </div>
