...
export const QuizResult: React.FC<QuizResultProps> = ({ score, total, onRetry, onNewQuiz }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto text-center mt-12">
      <h1 className="text-4xl font-bold text-white mb-8">Quiz hoàn thành!</h1>
      ...
      <div className="bg-gray-800 rounded-2xl p-8 mb-8 shadow-xl border border-gray-700">
        ...
        <div className="flex justify-center space-x-12">
          <div className="text-center">
            <div className="text-green-400 font-bold text-2xl mb-1">✓ Đúng: {score.correct}</div>
          </div>
          <div className="text-center">
            <div className="text-red-400 font-bold text-2xl mb-1">✕ Sai: {score.wrong}</div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
        <button
          onClick={onRetry}
          className="flex items-center justify-center px-8 py-4 rounded-xl font-bold transition-all bg-gray-700 text-white hover:bg-gray-600"
        >
